      ...
      <div className="flex flex-col gap-2 py-2 px-6 ">
        ...
        <div className=" bg-white p-4 rounded-xl uppercase text-xs font-semibold">
          <form className="flex flex-col gap-2" action="">
            ...
            <div className="flex flex-col">
              <p className="opacity-65 text-[10px]">phone umber :</p>
              <input className="p-2 rounded-lg uppercase" type="number" value='9593197988' disabled />
            </div>
            <div className="flex flex-col">
              <p className="opacity-65 text-[10px]">email id :</p>
              <input className="p-2 rounded-lg uppercase" type="email" value='debnathtaposh58@gmail.com' />
            </div>    
